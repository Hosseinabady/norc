...
public class RouterReportHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		IEditorInput input = new NoRCChartEditorInput(dataSet, type);
		try {
			
			page.openEditor(input, NoRCChartEditor.ID, true);
