...
int stdcqt[] = {
  ...
  99, 99, 99, 99, 99, 99, 99, 99,
  99, 99, 99, 99, 99, 99, 99, 99 };
double CorrectedLQT[64];
double CorrectedCQT[64];
int zigzag_order[64] = {
  0,   8,  1,  2,  9, 16, 24, 17,
...
struct huffentry ldht[] = {{0x0, 2}, {0x2, 3}, {0x3, 3}, {0x4, 3}, {0x5, 3}, {0x6, 3},
    {0xe, 4}, {0x1e, 5}, {0x3e, 6}, {0x7e, 7}, {0xfe, 8}, {0x1fe, 9}};

struct huffentry cdht[] = {{0x0, 2}, {0x1, 2}, {0x2, 2}, {0x6, 3}, {0xe, 4}, {0x1e, 5}, {0x3e, 6},
    {0x7e, 7}, {0xfe, 8}, {0x1fe, 9}, {0x3fe, 10}, {0x7fe, 11}};

struct huffentry laht[] = {{0x0a, 4}, {0x00, 2}, {0x01, 2}, {0x04, 3},
